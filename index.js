...
const events={
    ...
    3:{event:"Tech Trek(online)",
        ...
        notes:[
          ...
          "Ensure the project code is pushed to GitHub by the end of the hackathon.",
          "If the project is deployed, include the website link.",
          "Alternatively, submit a YouTube video (5-6 minutes) showcasing the working application.",
          "Each team will be assigned a mentor for 24-hour monitoring.",
          "Mentors will monitor the teams via Google Meet throughout the hackathon.",
        ],
